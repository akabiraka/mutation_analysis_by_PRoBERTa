...
from MutationClassification1.model import Net
...
for i in range(1, 13):
    ...
    model.load_state_dict(torch.load("outputs/models_mut_classify_balanced_data_1/{}_mut_classify.pt".format(i), map_location=torch.device(device)))
    model.eval()
