...
model.load_state_dict(torch.load("outputs/models_mut_classify_balanced_data/0_mut_classify_lr_0.001_epoch_1_batch_32.pt", map_location=torch.device(device)))
print(model)
